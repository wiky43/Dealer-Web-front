...
function traceNumberInput(e) {
    let focusedInput = document.querySelector(`.card-number`);
    let newString = "";
...
function traceNameInput(e) {
    ...
    let focusedInput = document.querySelector(`.card-holder-name`);
...
function traceDateInput(e) {
    let focusedInput = document.querySelector(`.valid-thru-date`);
    let newString = "";
...
function traceCodeInput(e) {
    let focusedInput = document.querySelector(`.security-code`);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const cardHolderNameInput = document.querySelector('input[name="card-holder-name"]');
    const validThruDateInput = document.querySelector('input[name="valid-thru-date"]');
    const securityCodeInput = document.querySelector('input[name="security-code"]');

    cardNumberInput.addEventListener('focus', flipCard);
    cardNumberInput.addEventListener('blur', deactivateBorder);
    cardNumberInput.addEventListener('keyup', traceNumberInput);

    cardHolderNameInput.addEventListener('focus', flipCard);
    cardHolderNameInput.addEventListener('blur', deactivateBorder);
    cardHolderNameInput.addEventListener('keyup', traceNameInput);

    validThruDateInput.addEventListener('focus', flipCard);
    validThruDateInput.addEventListener('blur', deactivateBorder);
    validThruDateInput.addEventListener('keyup', traceDateInput);

    securityCodeInput.addEventListener('focus', flipCard);
    securityCodeInput.addEventListener('blur', deactivateBorder);
    securityCodeInput.addEventListener('keyup', traceCodeInput);
